...
module("Coffeescript Class test");
...
test("Subclass", function() {
    ...
    CoffeeClass = (function() {
        function CoffeeClass(name) {
            this.name = name;
            console.log('[' + this.name + '] CoffeeClass::Constructor');
        }

        CoffeeClass.prototype.foo = function() {
            return console.log('[' + this.name + '] CoffeeClass::foo');
        };

        return CoffeeClass;
    })();

    var Module = Stapes.subclass(CoffeeClass);

    var a = new Module('a');
    var b = new Module('b');

    ok( a.name == 'a', 'Private attributes a' );
    ok( b.name == 'b', 'Private attributes b' );
    ok( typeof a.foo == 'function', 'Function a.foo exists' );
    ok( typeof b.foo == 'function', 'Function b.foo exists' );
